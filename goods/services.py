...
# Прояснить что я сделал вчера автопрогрев кеша каталога, разобрать dockerfile
# Отредактировать коментарии к коду удалить последний commit и заного commit 
# Приступить к рефакторингу goods/views